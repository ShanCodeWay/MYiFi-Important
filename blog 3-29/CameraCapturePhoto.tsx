...
const CameraCapturePhoto: React.FC<Props> = () => {
  ...
  const [isCapture,setIsCapture]= React.useState<boolean>(false);
  useEffect(() => {
...
{ !isCapture && (<View style={styles.buttonCaptureContainer}> 
  
 <TouchableOpacity style={styles.buttonCapture} onPress={handleBackCam}> 
  <Text style={styles.subtitle}> Capture  </Text>
...
{ isCapture && (<View style={styles.buttonCaptureContainer}>
  <TouchableOpacity style={styles.buttonRetry} onPress={handleBackCam}> 
  <Text style={styles.subtitle}> Retry  </Text>
</TouchableOpacity>
 <TouchableOpacity style={styles.buttonSave } onPress={handleBackCam}> 
...
textLite:{
  ...
  buttonRetry: {
    ...
    borderWidth: 3,
    paddingVertical: 8,
    backgroundColor: 'rgba(54, 203, 164, 0.7)',
  },
  buttonSave: {
    marginLeft: 10,
    width: '35%',
    ...
    backgroundColor: 'rgba(11, 111, 218, 0.7)',
  },
...
export default CameraCapturePhoto;