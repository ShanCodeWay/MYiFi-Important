...
import { GetBillPayementStyles } from "./BillPayementStyles";
...
class BillPayement extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    try {
      ...
      console.log("[BillPayement] - componentDidMount - Error ", Error);
    }
  }
  ...
  componentWillUnmount() {
    try {
      ...
      console.log("[BillPayement] - componentWillUnmount - Error ", Error);
    }
  }
  ...
  handleNextButtonPress = () => {
    try {
      ...
      console.log("Next button pressed to navigate to BillPayement");
    } catch (error) {
      console.log("[BillPayement] - Next_Button - Error ", error);
    }
  };
  ...
  handleLeftButtonPress = () => {
    try {
      ...
      console.log("[BillPayement] - left_Button - Error ", error);
    }
  };
  ...
  handleCategory = (selectedCategory) => {
    try {
      ...
      console.log("[BillPayement] - handleCategory - Error ", Error);
    }
  };
  ...
  handleShedual = (selectedShedual) => {
    try {
      ...
      console.log("[BillPayement] - handleShedual - Error ", Error);
    }
  };
  ...
  handleProvider = (selectedProvider) => {
    try {
      ...
      console.log("[BillPayement] - handleProvider - Error ", Error);
    }
  };
  ...
  handleAccount = (selectedAccount) => {
    try {
      ...
      console.log("[BillPayement] - handleAccount - Error ", Error);
    }
  };
  ...
  handleToAccount = (toAccount) => {
    try {
      ...
      console.log("[BillPayement] - handleToAccount - Error ", Error);
    }
  };
        ...
        <SafeAreaView style={GetCommonStyles(Android_Theme_Light).safeAreaView}>
          ...
          >
            <View style={GetCommonStyles(Android_Theme_Light).mainContainer}>
              <View
                style={GetBillPayementStyles(Android_Theme_Light).middleView}
              >
                <View style={{ height: 5 }} />

                <Text
                  style={GetBillPayementStyles(Android_Theme_Light).titleText}
                >
                  TRANSFER FROM
                </Text>
                <View style={{ height: 5 }} />
                <View
                  style={GetBillPayementStyles(Android_Theme_Light).bankView}
                >
                  <CommonSpinnerLong
                    width={"100%"}
                    data={[
                ...
                <View
                  style={
                    GetBillPayementStyles(Android_Theme_Light).spinnerContainer
                  }
                >
                  <View
                    style={GetBillPayementStyles(Android_Theme_Light).spinner}
                  >
                    <CommonSpinnerLong
                      width={"100%"}
                      data={[
                  ...
                  <View
                    style={GetBillPayementStyles(Android_Theme_Light).addbutton}
                  >
                    <CommonCardButton
              ...
              <View
                style={
                  GetBillPayementStyles(Android_Theme_Light).buttonContainer
                }
              >
                <View style={GetBillPayementStyles(Android_Theme_Light).button}>
                  <CommonButton
                    type="0"
                    title={"Now"}
                    borderRadius={10}
              ...
              {isExpanded && (
                <View
                  style={
                    GetBillPayementStyles(Android_Theme_Light).expandContainer
                  }
                >
                  <Text
                    style={GetBillPayementStyles(Android_Theme_Light).titleText}
          ...
          <View style={GetBillPayementStyles(Android_Theme_Light).bottomView}>
            <CommonButton
              type="1"
              title={"Next"}
              borderRadius={35}
