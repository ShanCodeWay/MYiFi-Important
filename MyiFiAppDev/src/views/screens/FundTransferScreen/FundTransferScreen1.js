...
import CommonButton from "../../components/Common/CommonButton";
  ...
  class FundTransferScreen1 extends Component {
    ...
    handleNextButtonPress = () => {
      try { this.props.navigation.replace(Index.fund_2); 
    ...
    handleLeftButtonPress = () => {
      try{ this.props.navigation.replace(Index.SIGNUP_5); 
          ...
          (error){ console.log("[fundTransferScreen1] - left_Button - Error ",error);}
  ...
  <View
        ...
        <View style={FundTransferScreenStyles1.bankView}> 
                          <CommonSpinnerLong
                          width={"90%"}
                          data={[
