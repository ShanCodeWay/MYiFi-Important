...
class AddNewBillerScreen extends Component {
  ...
  componentDidMount() {
    try {
      ...
      console.log("[AddNewBillerScreen] - componentDidMount - Error ", Error);
    }
  };
  componentWillUnmount() {
    try {
      ...
      console.log(
        "[AddNewBillerScreen] - componentWillUnmount - Error ",
        Error
      );
    }
  };
  ...
  handleSave = () => {
    try {
      this.props.navigation.navigate("BillerManagementScreen");
        ...
        console.log(
          "[AddNewBillerScreen] - handleSave - Error ",
          error
        );
      }
  };
  ...
  handleBack = () => {
    try {
      this.props.navigation.navigate("BillerManagementScreen");
        ...
        console.log(
          "[AddNewBillerScreen] - handleBack - Error ",
          error
        );
      }
  };
  ...
  handleHome = () => {
    try {
      this.props.navigation.navigate("DashboardScreen");
        ...
        console.log(
          "[AddNewBillerScreen] - handleHome - Error ",
          error
        );
      }
  };
  ...
  ServiceProvider = [
    ...
    {
      label_1: "National Water Supply and Drainage Board",
      value: "003",
      catCode: "003",
    },
      ...
      <SafeAreaView style={GetCommonStyles(Android_Theme_Light).safeAreaView}>
        ...
        >
          ...
          <View style={GetCommonStyles(Android_Theme_Light).mainContainer}>
            <View
              style={GetAddNewBillerScreenStyles(Android_Theme_Light).topView}
            >
              <View
                style={
                  GetAddNewBillerScreenStyles(Android_Theme_Light)
                    .nickNameContainer
                }
              >
                <CommonInputField
              ...
              >
                ...
                >
                  <Text
                    style={
                      GetAddNewBillerScreenStyles(Android_Theme_Light).labelText
                    }
                  >
                    Biller Category *
                  </Text>
                  <CommonSpinnerLong
                    ...
                    lable_1={
                      this.state.selectedCatogery || " Select Biller Category"
                    }
                    lable_2={""}
                    lable_2Show={false}
              ...
              >
                ...
                <CommonSpinnerLong
                  width={"100%"}
                  data={this.ServiceProvider.filter(
                    (item) => item.catCode === this.state.selectedCatogeryID
                  )}
                  placeholder={"add some placeholder"}
                  lable_1={
              ...
              {this.state.selectedCatogeryID === "002" ? (
                ...
                >
                  ...
                  <CommonSpinnerLong
                    ...
                    placeholder={"add some placeholder"}
                    lable_1={this.state.PakageType || "Select Package Type"}
                    T
                    //lable_2={this.state.selectedAmount || '457,685.54'}
                    lable_2Show={false}
            ...
            <View
              style={
                GetAddNewBillerScreenStyles(Android_Theme_Light).bottomView
              }
            >
              <CommonSmallButton
