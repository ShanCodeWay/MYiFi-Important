...
import CommonButton from "../../components/Common/CommonButton";
  ...
  <ElevatedView
          elevation={5}
          style={FoundTransferScreenStyles1.stayElevated}
        > 
        <Text style={FoundTransferScreenStyles1.titleText}>
          TRANSFER FROM
        </Text>
            <CommonSpinner
            title={"Account *"}
...
<View style={FoundTransferScreenStyles1.bottomView3}>
        <View style={FoundTransferScreenStyles1.bottomView1}>

<View style={FoundTransferScreenStyles1.bottomView2}>
